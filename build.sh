...
# Cài đặt các gói phụ thuộc cần thiết cho Chrome
sudo apt-get update
...
# Đảm bảo đường dẫn đến chromedriver khớp với phiên bản Chrome
# Thư viện undetected-chromedriver sẽ tự động tìm và tải driver phù hợp.